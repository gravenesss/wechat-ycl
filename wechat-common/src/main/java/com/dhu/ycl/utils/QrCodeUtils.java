...
public class QrCodeUtils {
    // D:/docker/minio_file
    private static final String QR_CODE_IMAGE_PATH = "D:/docker/minio_file";
    public static String generateQRCode(String data) {
        String filePath = QR_CODE_IMAGE_PATH + "/qr/qrcode.png";
    ...
    public static void main(String[] args) {
        String data = "Hello~ wechat"; // 二维码中的数据
        int width = 300; // 二维码的宽度
        int height = 300; // 二维码的高度
        String uuid = UUID.randomUUID().toString();
        String filePath = QR_CODE_IMAGE_PATH + "/qr/" + uuid + ".png"; // 生成的二维码文件的路径
